...
logger_name = os.getenv('LOGGER_NAME', 'CnnChestCancerMLflowDVC')   # Get log directory from environment variable, default to 'logs'

log_filepath = os.path.join(log_dir,"running_logs.log")             # Get logger name from environment variable, default to 'CnnChestCancerMLflowDVC'
